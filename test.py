...
# Load players
mmoe_model_load_path = "models/coach/moe_num_16_3627k"
agent_model_load_path =  "models/agent/actor_number_16_3627k_agent_{}.pth"
...
#     a= np.array([0.5555556285748345,-0.24560700389138262])#0.5555556285748345, y:-0.24560700389138262
#     b=np.array([-0.4476892,-0.37493712])
#     ab=np.linalg.norm(a-b)
#     print(ab)#0.05656854249492382
# print(0.04/(np.cos(np.pi/4)) + 0.02135)