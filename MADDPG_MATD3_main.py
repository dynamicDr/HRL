...
from coach_matd3 import Coach_MATD3
...
class Runner:
    def __init__(self, args, env_name, number, seed):
        ...
        print(f"action_dim={self.args.action_dim_n}")  # action_dim=[2, 2, 2]
        print(f"obs_dim={self.args.obs_dim_n}")  # o_dim=[40, 40, 40]
    ...
    def run(self):
        while self.episode < self.args.max_episode:
            ...
            print("============epi={},total_step={},avg_train_reward={}=============".format(self.episode,
                                                                                             self.total_steps,
                                                                                             avg_train_reward))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--restore_model_dir", type=str,
                        default="./model/VSSMA-v0/actor_number_0_step_272k_agent_{}.pth",
    ...
    parser.add_argument("--mmoe_model_load_path", type=str,
                        default="./mmoe_saved_model/model_mmoe_100")
    parser.add_argument("--mmoe_model_save_path", type=str,
                        default="./mmoe_saved_model/")
