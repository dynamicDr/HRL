...
from coach_nn import Coach_NN
from matd3 import MATD3
from replay_buffer import ReplayBuffer, CoachReplayBuffer
from rsoccer_gym.vss.env_ma import VSSMAEnv, VSSMAOpp
...
class Runner:
    def __init__(self, args, env_name, number, seed):
        ...
        self.seed = seed
        # Create env
        self.env: VSSMAOpp = gym.make(self.env_name)
        ...
        self.coach = Coach_NN(args, self.writer)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--restore_model_dir", type=str,
                        default="/home/user/football/HRL/models/agent/actor_number_23_2182k_agent_{}.pth",
    ...
    parser.add_argument("--restore_coach", type=bool, default=False, help="Restore from checkpoint")
