...
class ReplayBuffer(object):
    def __init__(self, args, opp=False):
        ...
        for agent_id in range(self.N):
            if opp:
                self.buffer_obs_n.append(np.empty((self.buffer_size, args.obs_dim_n[agent_id]-3)))
                ...
                self.buffer_s_next_n.append(np.empty((self.buffer_size, args.obs_dim_n[agent_id]-3)))
